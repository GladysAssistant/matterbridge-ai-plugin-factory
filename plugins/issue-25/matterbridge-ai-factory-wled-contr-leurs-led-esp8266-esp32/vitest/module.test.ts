...
const mockMatterbridge: PlatformMatterbridge = {
  ...
  rootDirectory: path.join('.cache', 'vitest', 'WledPlugin'),
  homeDirectory: path.join('.cache', 'vitest', 'WledPlugin'),
  matterbridgeDirectory: path.join('.cache', 'vitest', 'WledPlugin', '.matterbridge'),
  matterbridgePluginDirectory: path.join('.cache', 'vitest', 'WledPlugin', 'Matterbridge'),
  matterbridgeCertDirectory: path.join('.cache', 'vitest', 'WledPlugin', '.mattercert'),
  globalModulesDirectory: path.join('.cache', 'vitest', 'WledPlugin', 'node_modules'),
